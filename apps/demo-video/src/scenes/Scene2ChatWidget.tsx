    ...
    <div style={gradientBg}>
      ...
      <FadeIn startFrame={195} durationFrames={15}>
        ...
        >
          ...
          >
            "Prorated refunds are calculated based on remaining days in the billing cycle. Process
            via Billing → Refunds → Prorated."
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13 }}>
            <span style={{ color: COLORS.green, fontWeight: 600 }}>Confidence: 94.2%</span>
