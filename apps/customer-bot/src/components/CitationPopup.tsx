    ...
    >
      <div className="bg-white rounded shadow-lg p-6 max-w-md w-full relative">
        <button
          ...
          className="absolute top-2 right-2 text-gray-500 hover:text-gray-800 focus:ring-2 focus:ring-blue-400"
        >
          ✕
        </button>
        <h3 className="text-lg font-bold mb-2">Source Excerpt</h3>
        <blockquote className="italic text-gray-700 border-l-4 border-blue-400 pl-4 mb-3">
          {excerpt}
        </blockquote>
