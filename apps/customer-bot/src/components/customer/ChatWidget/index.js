...
export default function ChatWidget() {
  ...
  const [messages, setMessages] = useState([
    { from: 'bot', text: 'Hi! How can I help you today?', timestamp: new Date().toLocaleTimeString() }
  ]);
  ...
  if (minimized) {
    return (
      ...
      >
        <svg width="24" height="24" fill="none" viewBox="0 0 24 24"><rect y="9" width="24" height="6" rx="3" fill="currentColor"/></svg>
      </button>
    );
  }
